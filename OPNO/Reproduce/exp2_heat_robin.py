...
# In this experiment, we tested OPNO with basis functions satisfying Neumann BCs with different
# size of CGL discretization points.
# And this program is for the comparison with other deep-learning methods.

sub_list = [2**5, 2**3, 2**1]
batch_size_list = [4, 20]
sub = sub_list[0] ## modify this parameter to complete the whole example
batch_size = batch_size_list[0] ## modify this parameter to change the batch size
